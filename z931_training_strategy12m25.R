...
PARAM$final_train  <- c( 202006, 202007, 202008, 
                         202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105 ) #, 202104, 202105 --> donde voy a entrenar los Final Models


PARAM$train$training     <- c( 202006, 202007, 202008, 
                               202009, 202010, 202011, 202012, 202101, 202103 ) #202101, 202102, optimizacion de hiperparametros
...
fwrite( dataset[ fold_train + fold_validate + fold_test >= 1 , ],
        file= "dataset_training12m25.csv.gz",
        logical01= TRUE,
        sep= "," )
