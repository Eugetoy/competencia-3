...
kBO_iteraciones  <- 50  #iteraciones de la Optimizacion Bayesiana (baje de 50)
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_training12m25.csv.gz" )
